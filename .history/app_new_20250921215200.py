...
class VoiceBot:
    ...
    def start_continuous_recording(self):
        ...
        try:
            ...
            self.recording_thread = threading.Thread(target=record_chunk)
    ...
    def stop_continuous_recording(self):
        """Stop continuous recording and process the audio."""
        try:
            ...
            if not hasattr(self, 'recording_data') or not self.recording_data:
                return None
