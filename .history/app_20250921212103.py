...
AUDIO_RECORD        # with voice_tab3:
        if False:  # AUDIO_RECORDER_AVAILABLE:
            st.info("🎵 Web recorder feature disabled for compatibility")AVAILABLE = False  # Disabled for compatibility
